(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=e(s);fetch(s.href,n)}})();var V,Oe;class ht extends Error{}ht.prototype.name="InvalidTokenError";function ti(r){return decodeURIComponent(atob(r).replace(/(.)/g,(t,e)=>{let i=e.charCodeAt(0).toString(16).toUpperCase();return i.length<2&&(i="0"+i),"%"+i}))}function ei(r){let t=r.replace(/-/g,"+").replace(/_/g,"/");switch(t.length%4){case 0:break;case 2:t+="==";break;case 3:t+="=";break;default:throw new Error("base64 string is not of the correct length")}try{return ti(t)}catch{return atob(t)}}function as(r,t){if(typeof r!="string")throw new ht("Invalid token specified: must be a string");t||(t={});const e=t.header===!0?0:1,i=r.split(".")[e];if(typeof i!="string")throw new ht(`Invalid token specified: missing part #${e+1}`);let s;try{s=ei(i)}catch(n){throw new ht(`Invalid token specified: invalid base64 for part #${e+1} (${n.message})`)}try{return JSON.parse(s)}catch(n){throw new ht(`Invalid token specified: invalid json for part #${e+1} (${n.message})`)}}const si="mu:context",ee=`${si}:change`;class ii{constructor(t,e){this._proxy=ri(t,e)}get value(){return this._proxy}set value(t){Object.assign(this._proxy,t)}apply(t){this.value=t(this.value)}}class ae extends HTMLElement{constructor(t){super(),console.log("Constructing context provider",this),this.context=new ii(t,this),this.style.display="contents"}attach(t){return this.addEventListener(ee,t),t}detach(t){this.removeEventListener(ee,t)}}function ri(r,t){return new Proxy(r,{get:(i,s,n)=>{if(s==="then")return;const o=Reflect.get(i,s,n);return console.log(`Context['${s}'] => `,o),o},set:(i,s,n,o)=>{const c=r[s];console.log(`Context['${s.toString()}'] <= `,n);const a=Reflect.set(i,s,n,o);if(a){let u=new CustomEvent(ee,{bubbles:!0,cancelable:!0,composed:!0});Object.assign(u,{property:s,oldValue:c,value:n}),t.dispatchEvent(u)}else console.log(`Context['${s}] was not set to ${n}`);return a}})}function ni(r,t){const e=cs(t,r);return new Promise((i,s)=>{if(e){const n=e.localName;customElements.whenDefined(n).then(()=>i(e))}else s({context:t,reason:`No provider for this context "${t}:`})})}function cs(r,t){const e=`[provides="${r}"]`;if(!t||t===document.getRootNode())return;const i=t.closest(e);if(i)return i;const s=t.getRootNode();if(s instanceof ShadowRoot)return cs(r,s.host)}class oi extends CustomEvent{constructor(t,e="mu:message"){super(e,{bubbles:!0,composed:!0,detail:t})}}function ls(r="mu:message"){return(t,...e)=>t.dispatchEvent(new oi(e,r))}class ce{constructor(t,e,i="service:message",s=!0){this._pending=[],this._context=e,this._update=t,this._eventType=i,this._running=s}attach(t){t.addEventListener(this._eventType,e=>{e.stopPropagation();const i=e.detail;this.consume(i)})}start(){this._running||(console.log(`Starting ${this._eventType} service`),this._running=!0,this._pending.forEach(t=>this.process(t)))}apply(t){this._context.apply(t)}consume(t){this._running?this.process(t):(console.log(`Queueing ${this._eventType} message`,t),this._pending.push(t))}process(t){console.log(`Processing ${this._eventType} message`,t);const e=this._update(t,this.apply.bind(this));e&&e(this._context.value)}}function ai(r){return t=>({...t,...r})}const se="mu:auth:jwt",hs=class us extends ce{constructor(t,e){super((i,s)=>this.update(i,s),t,us.EVENT_TYPE),this._redirectForLogin=e}update(t,e){switch(t[0]){case"auth/signin":const{token:i,redirect:s}=t[1];return e(li(i)),Kt(s);case"auth/signout":return e(hi()),Kt(this._redirectForLogin);case"auth/redirect":return Kt(this._redirectForLogin,{next:window.location.href});default:const n=t[0];throw new Error(`Unhandled Auth message "${n}"`)}}};hs.EVENT_TYPE="auth:message";let ds=hs;const ps=ls(ds.EVENT_TYPE);function Kt(r,t={}){if(!r)return;const e=window.location.href,i=new URL(r,e);return Object.entries(t).forEach(([s,n])=>i.searchParams.set(s,n)),()=>{console.log("Redirecting to ",r),window.location.assign(i)}}class ci extends ae{get redirect(){return this.getAttribute("redirect")||void 0}constructor(){const t=G.authenticateFromLocalStorage();super({user:t,token:t.authenticated?t.token:void 0})}connectedCallback(){new ds(this.context,this.redirect).attach(this)}}class J{constructor(){this.authenticated=!1,this.username="anonymous"}static deauthenticate(t){return t.authenticated=!1,t.username="anonymous",localStorage.removeItem(se),t}}class G extends J{constructor(t){super();const e=as(t);console.log("Token payload",e),this.token=t,this.authenticated=!0,this.username=e.username}static authenticate(t){const e=new G(t);return localStorage.setItem(se,t),e}static authenticateFromLocalStorage(){const t=localStorage.getItem(se);return t?G.authenticate(t):new J}}function li(r){return ai({user:G.authenticate(r),token:r})}function hi(){return r=>{const t=r.user;return{user:t&&t.authenticated?J.deauthenticate(t):t,token:""}}}function ui(r){return r.authenticated?{Authorization:`Bearer ${r.token||"NO_TOKEN"}`}:{}}function di(r){return r.authenticated?as(r.token||""):{}}const xt=Object.freeze(Object.defineProperty({__proto__:null,AuthenticatedUser:G,Provider:ci,User:J,dispatch:ps,headers:ui,payload:di},Symbol.toStringTag,{value:"Module"}));function Ot(r,t,e){const i=r.target,s=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});console.log(`Relaying event from ${r.type}:`,s),i.dispatchEvent(s),r.stopPropagation()}function ie(r,t="*"){return r.composedPath().find(i=>{const s=i;return s.tagName&&s.matches(t)})}const pi=Object.freeze(Object.defineProperty({__proto__:null,originalTarget:ie,relay:Ot},Symbol.toStringTag,{value:"Module"}));function fs(r,...t){const e=r.map((s,n)=>n?[t[n-1],s]:[s]).flat().join("");let i=new CSSStyleSheet;return i.replaceSync(e),i}const fi=new DOMParser;function H(r,...t){const e=t.map(c),i=r.map((a,u)=>{if(u===0)return[a];const p=e[u-1];return p instanceof Node?[`<ins id="mu-html-${u-1}"></ins>`,a]:[p,a]}).flat().join(""),s=fi.parseFromString(i,"text/html"),n=s.head.childElementCount?s.head.children:s.body.children,o=new DocumentFragment;return o.replaceChildren(...n),e.forEach((a,u)=>{if(a instanceof Node){const p=o.querySelector(`ins#mu-html-${u}`);if(p){const h=p.parentNode;h==null||h.replaceChild(a,p)}else console.log("Missing insertion point:",`ins#mu-html-${u}`)}}),o;function c(a,u){if(a===null)return"";switch(typeof a){case"string":return Ue(a);case"bigint":case"boolean":case"number":case"symbol":return Ue(a.toString());case"object":if(a instanceof Node||a instanceof DocumentFragment)return a;if(Array.isArray(a)){const p=new DocumentFragment,h=a.map(c);return p.replaceChildren(...h),p}return new Text(a.toString());default:return new Comment(`[invalid parameter of type "${typeof a}"]`)}}}function Ue(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Dt(r,t={mode:"open"}){const e=r.attachShadow(t),i={template:s,styles:n};return i;function s(o){const c=o.firstElementChild,a=c&&c.tagName==="TEMPLATE"?c:void 0;return a&&e.appendChild(a.content.cloneNode(!0)),i}function n(...o){e.adoptedStyleSheets=o}}V=class extends HTMLElement{constructor(){super(),this._state={},Dt(this).template(V.template).styles(V.styles),this.addEventListener("change",r=>{const t=r.target;if(t){const e=t.name,i=t.value;e&&(this._state[e]=i)}}),this.form&&this.form.addEventListener("submit",r=>{r.preventDefault(),Ot(r,"mu-form:submit",this._state)})}set init(r){this._state=r||{},gi(this._state,this)}get form(){var r;return(r=this.shadowRoot)==null?void 0:r.querySelector("form")}},V.template=H`
  ...
  `;function gi(r,t){const e=Object.entries(r);for(const[i,s]of e){const n=t.querySelector(`[name="${i}"]`);if(n){const o=n;switch(o.type){case"checkbox":const c=o;c.checked=!!s;break;case"date":o.value=s.toISOString().substr(0,10);break;default:o.value=s;break}}}return r}const gs=class ms extends ce{constructor(t){super((e,i)=>this.update(e,i),t,ms.EVENT_TYPE)}update(t,e){switch(t[0]){case"history/navigate":{const{href:i,state:s}=t[1];e(yi(i,s));break}case"history/redirect":{const{href:i,state:s}=t[1];e(vi(i,s));break}}}};gs.EVENT_TYPE="history:message";let le=gs;class Ie extends ae{constructor(){super({location:document.location,state:{}}),this.addEventListener("click",t=>{const e=mi(t);if(e){const i=new URL(e.href);i.origin===this.context.value.location.origin&&(console.log("Preventing Click Event on <A>",t),t.preventDefault(),he(e,"history/navigate",{href:i.pathname+i.search}))}}),window.addEventListener("popstate",t=>{console.log("Popstate",t.state),this.context.value={location:document.location,state:t.state}})}connectedCallback(){new le(this.context).attach(this)}}function mi(r){const t=r.currentTarget,e=i=>i.tagName=="A"&&i.href;if(r.button===0)if(r.composed){const s=r.composedPath().find(e);return s||void 0}else{for(let i=r.target;i;i===t?null:i.parentElement)if(e(i))return i;return}}function yi(r,t={}){return history.pushState(t,"",r),()=>({location:document.location,state:history.state})}function vi(r,t={}){return history.replaceState(t,"",r),()=>({location:document.location,state:history.state})}const he=ls(le.EVENT_TYPE),_i=Object.freeze(Object.defineProperty({__proto__:null,HistoryProvider:Ie,Provider:Ie,Service:le,dispatch:he},Symbol.toStringTag,{value:"Module"}));class ft{constructor(t,e){this._effects=[],this._target=t,this._contextLabel=e}observe(t=void 0){return new Promise((e,i)=>{if(this._provider){const s=new Ne(this._provider,t);this._effects.push(s),e(s)}else ni(this._target,this._contextLabel).then(s=>{const n=new Ne(s,t);this._provider=s,this._effects.push(n),s.attach(o=>this._handleChange(o)),e(n)}).catch(s=>console.log(`Observer ${this._contextLabel}: ${s}`,s))})}_handleChange(t){console.log("Received change event for observers",t,this._effects),t.stopPropagation(),this._effects.forEach(e=>e.runEffect())}}class Ne{constructor(t,e){this._provider=t,e&&this.setEffect(e)}get context(){return this._provider.context}get value(){return this.context.value}setEffect(t){this._effectFn=t,this.runEffect()}runEffect(){this._effectFn&&this._effectFn(this.context.value)}}const ys=class vs extends HTMLElement{constructor(){super(),this._state={},this._user=new J,this._authObserver=new ft(this,"blazing:auth"),Dt(this).template(vs.template),this.form&&this.form.addEventListener("submit",t=>{if(t.preventDefault(),this.src||this.action){if(console.log("Submitting form",this._state),this.action)this.action(this._state);else if(this.src){const e=this.isNew?"POST":"PUT",i=this.isNew?"created":"updated",s=this.isNew?this.src.replace(/[/][$]new$/,""):this.src;bi(s,this._state,e,this.authorization).then(n=>ot(n,this)).then(n=>{const o=`mu-rest-form:${i}`,c=new CustomEvent(o,{bubbles:!0,composed:!0,detail:{method:e,[i]:n,url:s}});this.dispatchEvent(c)}).catch(n=>{const o="mu-rest-form:error",c=new CustomEvent(o,{bubbles:!0,composed:!0,detail:{method:e,error:n,url:s,request:this._state}});this.dispatchEvent(c)})}}}),this.addEventListener("change",t=>{const e=t.target;if(e){const i=e.name,s=e.value;i&&(this._state[i]=s)}})}get src(){return this.getAttribute("src")}get isNew(){return this.hasAttribute("new")}set init(t){this._state=t||{},ot(this._state,this)}get form(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("form")}get authorization(){var t;return(t=this._user)!=null&&t.authenticated?{Authorization:`Bearer ${this._user.token}`}:{}}connectedCallback(){this._authObserver.observe(({user:t})=>{t&&(this._user=t,this.src&&!this.isNew&&Me(this.src,this.authorization).then(e=>{this._state=e,ot(e,this)}))})}attributeChangedCallback(t,e,i){switch(t){case"src":this.src&&i&&i!==e&&!this.isNew&&Me(this.src,this.authorization).then(s=>{this._state=s,ot(s,this)});break;case"new":i&&(this._state={},ot({},this));break}}};ys.observedAttributes=["src","new","action"];ys.template=H`
    <template>
      <form autocomplete="off">
        <slot></slot>
        <slot name="submit">
  ...
  `;function Me(r,t){return fetch(r,{headers:t}).then(e=>{if(e.status!==200)throw`Status: ${e.status}`;return e.json()}).catch(e=>console.log(`Failed to load form from ${r}:`,e))}function ot(r,t){const e=Object.entries(r);for(const[i,s]of e){const n=t.querySelector(`[name="${i}"]`);if(n){const o=n;switch(o.type){case"checkbox":const c=o;c.checked=!!s;break;default:o.value=s;break}}}return r}function bi(r,t,e="PUT",i={}){return fetch(r,{method:e,headers:{"Content-Type":"application/json",...i},body:JSON.stringify(t)}).then(s=>{if(s.status!=200&&s.status!=201)throw`Form submission failed: Status ${s.status}`;return s.json()})}const _s=class bs extends ce{constructor(t,e){super(e,t,bs.EVENT_TYPE,!1)}};_s.EVENT_TYPE="mu:message";let $s=_s;class $i extends ae{constructor(t,e,i){super(e),this._user=new J,this._updateFn=t,this._authObserver=new ft(this,i)}connectedCallback(){const t=new $s(this.context,(e,i)=>this._updateFn(e,i,this._user));t.attach(this),this._authObserver.observe(({user:e})=>{console.log("Store got auth",e),e&&(this._user=e),t.start()})}}const ws=Object.freeze(Object.defineProperty({__proto__:null,Provider:$i,Service:$s},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Tt=globalThis,ue=Tt.ShadowRoot&&(Tt.ShadyCSS===void 0||Tt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,de=Symbol(),Le=new WeakMap;let xs=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==de)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(ue&&t===void 0){const i=e!==void 0&&e.length===1;i&&(t=Le.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&Le.set(e,t))}return t}toString(){return this.cssText}};const wi=r=>new xs(typeof r=="string"?r:r+"",void 0,de),xi=(r,...t)=>{const e=r.length===1?r[0]:t.reduce((i,s,n)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+r[n+1],r[0]);return new xs(e,r,de)},Ai=(r,t)=>{if(ue)r.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const i=document.createElement("style"),s=Tt.litNonce;s!==void 0&&i.setAttribute("nonce",s),i.textContent=e.cssText,r.appendChild(i)}},je=ue?r=>r:r=>r instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return wi(e)})(r):r;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Ei,defineProperty:Si,getOwnPropertyDescriptor:ki,getOwnPropertyNames:Pi,getOwnPropertySymbols:Ci,getPrototypeOf:Ti}=Object,Z=globalThis,He=Z.trustedTypes,Ri=He?He.emptyScript:"",ze=Z.reactiveElementPolyfillSupport,ut=(r,t)=>r,Ut={toAttribute(r,t){switch(t){case Boolean:r=r?Ri:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,t){let e=r;switch(t){case Boolean:e=r!==null;break;case Number:e=r===null?null:Number(r);break;case Object:case Array:try{e=JSON.parse(r)}catch{e=null}}return e}},pe=(r,t)=>!Ei(r,t),De={attribute:!0,type:String,converter:Ut,reflect:!1,hasChanged:pe};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),Z.litPropertyMetadata??(Z.litPropertyMetadata=new WeakMap);let W=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=De){if(e.state&&(e.attribute=!1),this._$Ei(),this.elementProperties.set(t,e),!e.noAccessor){const i=Symbol(),s=this.getPropertyDescriptor(t,i,e);s!==void 0&&Si(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){const{get:s,set:n}=ki(this.prototype,t)??{get(){return this[e]},set(o){this[e]=o}};return{get(){return s==null?void 0:s.call(this)},set(o){const c=s==null?void 0:s.call(this);n.call(this,o),this.requestUpdate(t,c,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??De}static _$Ei(){if(this.hasOwnProperty(ut("elementProperties")))return;const t=Ti(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(ut("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ut("properties"))){const e=this.properties,i=[...Pi(e),...Ci(e)];for(const s of i)this.createProperty(s,e[s])}const t=this[Symbol.metadata];if(t!==null){const e=litPropertyMetadata.get(t);if(e!==void 0)for(const[i,s]of e)this.elementProperties.set(i,s)}this._$Eh=new Map;for(const[e,i]of this.elementProperties){const s=this._$Eu(e,i);s!==void 0&&this._$Eh.set(s,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const s of i)e.unshift(je(s))}else t!==void 0&&e.push(je(t));return e}static _$Eu(t,e){const i=e.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(e=>e(this))}addController(t){var e;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((e=t.hostConnected)==null||e.call(t))}removeController(t){var e;(e=this._$EO)==null||e.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ai(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(e=>{var i;return(i=e.hostConnected)==null?void 0:i.call(e)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(e=>{var i;return(i=e.hostDisconnected)==null?void 0:i.call(e)})}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$EC(t,e){var i;const s=this.constructor.elementProperties.get(t),n=this.constructor._$Eu(t,s);if(n!==void 0&&s.reflect===!0){const o=(((i=s.converter)==null?void 0:i.toAttribute)!==void 0?s.converter:Ut).toAttribute(e,s.type);this._$Em=t,o==null?this.removeAttribute(n):this.setAttribute(n,o),this._$Em=null}}_$AK(t,e){var i;const s=this.constructor,n=s._$Eh.get(t);if(n!==void 0&&this._$Em!==n){const o=s.getPropertyOptions(n),c=typeof o.converter=="function"?{fromAttribute:o.converter}:((i=o.converter)==null?void 0:i.fromAttribute)!==void 0?o.converter:Ut;this._$Em=n,this[n]=c.fromAttribute(e,o.type),this._$Em=null}}requestUpdate(t,e,i){if(t!==void 0){if(i??(i=this.constructor.getPropertyOptions(t)),!(i.hasChanged??pe)(this[t],e))return;this.P(t,e,i)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(t,e,i){this._$AL.has(t)||this._$AL.set(t,e),i.reflect===!0&&this._$Em!==t&&(this._$Ej??(this._$Ej=new Set)).add(t)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[n,o]of this._$Ep)this[n]=o;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[n,o]of s)o.wrapped!==!0||this._$AL.has(n)||this[n]===void 0||this.P(n,this[n],o)}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),(t=this._$EO)==null||t.forEach(s=>{var n;return(n=s.hostUpdate)==null?void 0:n.call(s)}),this.update(i)):this._$EU()}catch(s){throw e=!1,this._$EU(),s}e&&this._$AE(i)}willUpdate(t){}_$AE(t){var e;(e=this._$EO)==null||e.forEach(i=>{var s;return(s=i.hostUpdated)==null?void 0:s.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Ej&&(this._$Ej=this._$Ej.forEach(e=>this._$EC(e,this[e]))),this._$EU()}updated(t){}firstUpdated(t){}};W.elementStyles=[],W.shadowRootOptions={mode:"open"},W[ut("elementProperties")]=new Map,W[ut("finalized")]=new Map,ze==null||ze({ReactiveElement:W}),(Z.reactiveElementVersions??(Z.reactiveElementVersions=[])).push("2.0.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const It=globalThis,Nt=It.trustedTypes,Fe=Nt?Nt.createPolicy("lit-html",{createHTML:r=>r}):void 0,As="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,Es="?"+C,Oi=`<${Es}>`,z=document,gt=()=>z.createComment(""),mt=r=>r===null||typeof r!="object"&&typeof r!="function",fe=Array.isArray,Ui=r=>fe(r)||typeof(r==null?void 0:r[Symbol.iterator])=="function",Jt=`[ 	
\f\r]`,at=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,qe=/-->/g,Be=/>/g,N=RegExp(`>|${Jt}(?:([^\\s"'>=/]+)(${Jt}*=${Jt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ve=/'/g,Qe=/"/g,Ss=/^(?:script|style|textarea|title)$/i,Ii=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),ct=Ii(1),X=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),We=new WeakMap,L=z.createTreeWalker(z,129);function ks(r,t){if(!fe(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return Fe!==void 0?Fe.createHTML(t):t}const Ni=(r,t)=>{const e=r.length-1,i=[];let s,n=t===2?"<svg>":t===3?"<math>":"",o=at;for(let c=0;c<e;c++){const a=r[c];let u,p,h=-1,l=0;for(;l<a.length&&(o.lastIndex=l,p=o.exec(a),p!==null);)l=o.lastIndex,o===at?p[1]==="!--"?o=qe:p[1]!==void 0?o=Be:p[2]!==void 0?(Ss.test(p[2])&&(s=RegExp("</"+p[2],"g")),o=N):p[3]!==void 0&&(o=N):o===N?p[0]===">"?(o=s??at,h=-1):p[1]===void 0?h=-2:(h=o.lastIndex-p[2].length,u=p[1],o=p[3]===void 0?N:p[3]==='"'?Qe:Ve):o===Qe||o===Ve?o=N:o===qe||o===Be?o=at:(o=N,s=void 0);const d=o===N&&r[c+1].startsWith("/>")?" ":"";n+=o===at?a+Oi:h>=0?(i.push(u),a.slice(0,h)+As+a.slice(h)+C+d):a+C+(h===-2?c:d)}return[ks(r,n+(r[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]};let re=class Ps{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let n=0,o=0;const c=t.length-1,a=this.parts,[u,p]=Ni(t,e);if(this.el=Ps.createElement(u,i),L.currentNode=this.el.content,e===2||e===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(s=L.nextNode())!==null&&a.length<c;){if(s.nodeType===1){if(s.hasAttributes())for(const h of s.getAttributeNames())if(h.endsWith(As)){const l=p[o++],d=s.getAttribute(h).split(C),f=/([.?@])?(.*)/.exec(l);a.push({type:1,index:n,name:f[2],strings:d,ctor:f[1]==="."?Li:f[1]==="?"?ji:f[1]==="@"?Hi:Ft}),s.removeAttribute(h)}else h.startsWith(C)&&(a.push({type:6,index:n}),s.removeAttribute(h));if(Ss.test(s.tagName)){const h=s.textContent.split(C),l=h.length-1;if(l>0){s.textContent=Nt?Nt.emptyScript:"";for(let d=0;d<l;d++)s.append(h[d],gt()),L.nextNode(),a.push({type:2,index:++n});s.append(h[l],gt())}}}else if(s.nodeType===8)if(s.data===Es)a.push({type:2,index:n});else{let h=-1;for(;(h=s.data.indexOf(C,h+1))!==-1;)a.push({type:7,index:n}),h+=C.length-1}n++}}static createElement(t,e){const i=z.createElement("template");return i.innerHTML=t,i}};function tt(r,t,e=r,i){var s,n;if(t===X)return t;let o=i!==void 0?(s=e.o)==null?void 0:s[i]:e.l;const c=mt(t)?void 0:t._$litDirective$;return(o==null?void 0:o.constructor)!==c&&((n=o==null?void 0:o._$AO)==null||n.call(o,!1),c===void 0?o=void 0:(o=new c(r),o._$AT(r,e,i)),i!==void 0?(e.o??(e.o=[]))[i]=o:e.l=o),o!==void 0&&(t=tt(r,o._$AS(r,t.values),o,i)),t}class Mi{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=((t==null?void 0:t.creationScope)??z).importNode(e,!0);L.currentNode=s;let n=L.nextNode(),o=0,c=0,a=i[0];for(;a!==void 0;){if(o===a.index){let u;a.type===2?u=new At(n,n.nextSibling,this,t):a.type===1?u=new a.ctor(n,a.name,a.strings,this,t):a.type===6&&(u=new zi(n,this,t)),this._$AV.push(u),a=i[++c]}o!==(a==null?void 0:a.index)&&(n=L.nextNode(),o++)}return L.currentNode=z,s}p(t){let e=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class At{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this.v}constructor(t,e,i,s){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this.v=(s==null?void 0:s.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=tt(this,t,e),mt(t)?t===b||t==null||t===""?(this._$AH!==b&&this._$AR(),this._$AH=b):t!==this._$AH&&t!==X&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Ui(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==b&&mt(this._$AH)?this._$AA.nextSibling.data=t:this.T(z.createTextNode(t)),this._$AH=t}$(t){var e;const{values:i,_$litType$:s}=t,n=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=re.createElement(ks(s.h,s.h[0]),this.options)),s);if(((e=this._$AH)==null?void 0:e._$AD)===n)this._$AH.p(i);else{const o=new Mi(n,this),c=o.u(this.options);o.p(i),this.T(c),this._$AH=o}}_$AC(t){let e=We.get(t.strings);return e===void 0&&We.set(t.strings,e=new re(t)),e}k(t){fe(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const n of t)s===e.length?e.push(i=new At(this.O(gt()),this.O(gt()),this,this.options)):i=e[s],i._$AI(n),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,e);t&&t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){var e;this._$AM===void 0&&(this.v=t,(e=this._$AP)==null||e.call(this,t))}}class Ft{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,n){this.type=1,this._$AH=b,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=b}_$AI(t,e=this,i,s){const n=this.strings;let o=!1;if(n===void 0)t=tt(this,t,e,0),o=!mt(t)||t!==this._$AH&&t!==X,o&&(this._$AH=t);else{const c=t;let a,u;for(t=n[0],a=0;a<n.length-1;a++)u=tt(this,c[i+a],e,a),u===X&&(u=this._$AH[a]),o||(o=!mt(u)||u!==this._$AH[a]),u===b?t=b:t!==b&&(t+=(u??"")+n[a+1]),this._$AH[a]=u}o&&!s&&this.j(t)}j(t){t===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Li extends Ft{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===b?void 0:t}}class ji extends Ft{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==b)}}class Hi extends Ft{constructor(t,e,i,s,n){super(t,e,i,s,n),this.type=5}_$AI(t,e=this){if((t=tt(this,t,e,0)??b)===X)return;const i=this._$AH,s=t===b&&i!==b||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==b&&(i===b||s);s&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}}class zi{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){tt(this,t)}}const Ye=It.litHtmlPolyfillSupport;Ye==null||Ye(re,At),(It.litHtmlVersions??(It.litHtmlVersions=[])).push("3.2.0");const Di=(r,t,e)=>{const i=(e==null?void 0:e.renderBefore)??t;let s=i._$litPart$;if(s===void 0){const n=(e==null?void 0:e.renderBefore)??null;i._$litPart$=s=new At(t.insertBefore(gt(),n),n,void 0,e??{})}return s._$AI(r),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`+this.showPosition(),{text:"",token:null,line:this.yylineno})},lex:function(){var d=this.next();return d||this.lex()},begin:function(d){this.conditionStack.push(d)},popState:function(){var d=this.conditionStack.length-1;return d>0?this.conditionStack.pop():this.conditionStack[0]},_currentRules:function(){return this.conditionStack.length&&this.conditionStack[this.conditionStack.length-1]?this.conditions[this.conditionStack[this.conditionStack.length-1]].rules:this.conditions.INITIAL.rules},topState:function(d){return d=this.conditionStack.length-1-Math.abs(d||0),d>=0?this.conditionStack[d]:"INITIAL"},pushState:function(d){this.begin(d)},stateStackSize:function(){return this.conditionStack.length},options:{},performAction:function(d,f,m,g){switch(m){case 0:return"(";case 1:return")";case 2:return"SPLAT";case 3:return"PARAM";case 4:return"LITERAL";case 5:return"LITERAL";case 6:return"EOF"}},rules:[/^(?:\()/,/^(?:\))/,/^(?:\*+\w+)/,/^(?::+\w+)/,/^(?:[\w%\-~\n]+)/,/^(?:.)/,/^(?:$)/],conditions:{INITIAL:{rules:[0,1,2,3,4,5,6],inclusive:!0}}};return h}();a.lexer=u;function p(){this.yy={}}return p.prototype=a,a.Parser=p,new p}();typeof Vi<"u"&&(r.parser=t,r.Parser=t.Parser,r.parse=function(){return t.parse.apply(t,arguments)})})(Rs);function Q(r){return function(t,e){return{displayName:r,props:t,children:e||[]}}}var Os={Root:Q("Root"),Concat:Q("Concat"),Literal:Q("Literal"),Splat:Q("Splat"),Param:Q("Param"),Optional:Q("Optional")},Us=Rs.parser;Us.yy=Os;var Qi=Us,Wi=Object.keys(Os);function Yi(r){return Wi.forEach(function(t){if(typeof r[t]>"u")throw new Error("No handler defined for "+t.displayName)}),{visit:function(t,e){return this.handlers[t.displayName].call(this,t,e)},handlers:r}}var Is=Yi,Ki=Is,Ji=/[\-{}\[\]+?.,\\\^$|#\s]/g;function Ns(r){this.captures=r.captures,this.re=r.re}Ns.prototype.match=function(r){var t=this.re.exec(r),e={};if(t)return this.captures.forEach(function(i,s){typeof t[s+1]>"u"?e[i]=void 0:e[i]=decodeURIComponent(t[s+1])}),e};var Gi=Ki({Concat:function(r){return r.children.reduce((function(t,e){var i=this.visit(e);return{re:t.re+i.re,captures:t.captures.concat(i.captures)}}).bind(this),{re:"",captures:[]})},Literal:function(r){return{re:r.props.value.replace(Ji,"\\$&"),captures:[]}},Splat:function(r){return{re:"([^?]*?)",captures:[r.props.name]}},Param:function(r){return{re:"([^\\/\\?]+)",captures:[r.props.name]}},Optional:function(r){var t=this.visit(r.children[0]);return{re:"(?:"+t.re+")?",captures:t.captures}},Root:function(r){var t=this.visit(r.children[0]);return new Ns({re:new RegExp("^"+t.re+"(?=\\?|$)"),captures:t.captures})}}),Zi=Gi,Xi=Is,tr=Xi({Concat:function(r,t){var e=r.children.map((function(i){return this.visit(i,t)}).bind(this));return e.some(function(i){return i===!1})?!1:e.join("")},Literal:function(r){return decodeURI(r.props.value)},Splat:function(r,t){return t[r.props.name]?t[r.props.name]:!1},Param:function(r,t){return t[r.props.name]?t[r.props.name]:!1},Optional:function(r,t){var e=this.visit(r.children[0],t);return e||""},Root:function(r,t){t=t||{};var e=this.visit(r.children[0],t);return e?encodeURI(e):!1}}),er=tr,sr=Qi,ir=Zi,rr=er;Et.prototype=Object.create(null);Et.prototype.match=function(r){var t=ir.visit(this.ast),e=t.match(r);return e||!1};Et.prototype.reverse=function(r){return rr.visit(this.ast,r)};function Et(r){var t;if(this?t=this:t=Object.create(Et.prototype),typeof r>"u")throw new Error("A route spec is required");return t.spec=r,t.ast=sr.parse(r),t}var nr=Et,or=nr,ar=or;const cr=Bi(ar);var lr=Object.defineProperty,Ms=(r,t,e,i)=>{for(var s=void 0,n=r.length-1,o;n>=0;n--)(o=r[n])&&(s=o(t,e,s)||s);return s&&lr(t,e,s),s};const Ls=class extends K{constructor(t,e,i=""){super(),this._cases=[],this._fallback=()=>ct` <h1>Not Found</h1> `,this._cases=t.map(s=>({...s,route:new cr(s.path)})),this._historyObserver=new ft(this,e),this._authObserver=new ft(this,i)}connectedCallback(){this._historyObserver.observe(({location:t})=>{console.log("New location",t),t&&(this._match=this.matchRoute(t))}),this._authObserver.observe(({user:t})=>{this._user=t}),super.connectedCallback()}render(){return console.log("Rendering for match",this._match,this._user),ct` <main>${(()=>{const e=this._match;if(e){if("view"in e)return this._user?e.auth&&e.auth!=="public"&&this._user&&!this._user.authenticated?(ps(this,"auth/redirect"),ct` <h1>Redirecting for Login</h1> `):(console.log("Loading view, ",e.params,e.query),e.view(e.params||{},e.query)):ct` <h1>Authenticating</h1> `;if("redirect"in e){const i=e.redirect;if(typeof i=="string")return this.redirect(i),ct` <h1>Redirecting to ${i}…</h1> `}}return this._fallback({})})()}</main> `}updated(t){t.has("_match")&&this.requestUpdate()}matchRoute(t){const{search:e,pathname:i}=t,s=new URLSearchParams(e),n=i+e;for(const o of this._cases){const c=o.route.match(n);if(c)return{...o,path:i,params:c,query:s}}}redirect(t){he(this,"history/redirect",{href:t})}};Ls.styles=xi`
  ...
  `;const Hs=class ne extends HTMLElement{constructor(){super(),this._array=[],Dt(this).template(ne.template).styles(ne.styles),this.addEventListener("input-array:add",t=>{t.stopPropagation(),this.append(zs("",this._array.length))}),this.addEventListener("input-array:remove",t=>{t.stopPropagation(),this.removeClosestItem(t.target)}),this.addEventListener("change",t=>{t.stopPropagation();const e=t.target;if(e&&e!==this){const i=new Event("change",{bubbles:!0}),s=e.value,n=e.closest("label");if(n){const o=Array.from(this.children).indexOf(n);this._array[o]=s,this.dispatchEvent(i)}}}),this.addEventListener("click",t=>{ie(t,"button.add")?Ot(t,"input-array:add"):ie(t,"button.remove")&&Ot(t,"input-array:remove")})}get name(){return this.getAttribute("name")}get value(){return this._array}set value(t){this._array=Array.isArray(t)?t:[t],dr(this._array,this)}removeClosestItem(t){const e=t.closest("label");if(console.log("Removing closest item:",e,t),e){const i=Array.from(this.children).indexOf(e);this._array.splice(i,1),e.remove()}}};Hs.template=H`
    <template>
      <ul>
        <slot></slot>
      </ul>
...
\f\r]`,lt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,es=/-->/g,ss=/>/g,M=RegExp(`>|${Zt}(?:([^\\s"'>=/]+)(${Zt}*=${Zt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),is=/'/g,rs=/"/g,Bs=/^(?:script|style|textarea|title)$/i,kr=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),y=kr(1),et=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),ns=new WeakMap,j=D.createTreeWalker(D,129);function Vs(r,t){if(!ve(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return ts!==void 0?ts.createHTML(t):t}const Pr=(r,t)=>{const e=r.length-1,i=[];let s,n=t===2?"<svg>":t===3?"<math>":"",o=lt;for(let c=0;c<e;c++){const a=r[c];let u,p,h=-1,l=0;for(;l<a.length&&(o.lastIndex=l,p=o.exec(a),p!==null);)l=o.lastIndex,o===lt?p[1]==="!--"?o=es:p[1]!==void 0?o=ss:p[2]!==void 0?(Bs.test(p[2])&&(s=RegExp("</"+p[2],"g")),o=M):p[3]!==void 0&&(o=M):o===M?p[0]===">"?(o=s??lt,h=-1):p[1]===void 0?h=-2:(h=o.lastIndex-p[2].length,u=p[1],o=p[3]===void 0?M:p[3]==='"'?rs:is):o===rs||o===is?o=M:o===es||o===ss?o=lt:(o=M,s=void 0);const d=o===M&&r[c+1].startsWith("/>")?" ":"";n+=o===lt?a+Er:h>=0?(i.push(u),a.slice(0,h)+Fs+a.slice(h)+T+d):a+T+(h===-2?c:d)}return[Vs(r,n+(r[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]};class _t{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let n=0,o=0;const c=t.length-1,a=this.parts,[u,p]=Pr(t,e);if(this.el=_t.createElement(u,i),j.currentNode=this.el.content,e===2||e===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(s=j.nextNode())!==null&&a.length<c;){if(s.nodeType===1){if(s.hasAttributes())for(const h of s.getAttributeNames())if(h.endsWith(Fs)){const l=p[o++],d=s.getAttribute(h).split(T),f=/([.?@])?(.*)/.exec(l);a.push({type:1,index:n,name:f[2],strings:d,ctor:f[1]==="."?Tr:f[1]==="?"?Rr:f[1]==="@"?Or:qt}),s.removeAttribute(h)}else h.startsWith(T)&&(a.push({type:6,index:n}),s.removeAttribute(h));if(Bs.test(s.tagName)){const h=s.textContent.split(T),l=h.length-1;if(l>0){s.textContent=jt?jt.emptyScript:"";for(let d=0;d<l;d++)s.append(h[d],yt()),j.nextNode(),a.push({type:2,index:++n});s.append(h[l],yt())}}}else if(s.nodeType===8)if(s.data===qs)a.push({type:2,index:n});else{let h=-1;for(;(h=s.data.indexOf(T,h+1))!==-1;)a.push({type:7,index:n}),h+=T.length-1}n++}}static createElement(t,e){const i=D.createElement("template");return i.innerHTML=t,i}}function st(r,t,e=r,i){var o,c;if(t===et)return t;let s=i!==void 0?(o=e._$Co)==null?void 0:o[i]:e._$Cl;const n=vt(t)?void 0:t._$litDirective$;return(s==null?void 0:s.constructor)!==n&&((c=s==null?void 0:s._$AO)==null||c.call(s,!1),n===void 0?s=void 0:(s=new n(r),s._$AT(r,e,i)),i!==void 0?(e._$Co??(e._$Co=[]))[i]=s:e._$Cl=s),s!==void 0&&(t=st(r,s._$AS(r,t.values),s,i)),t}class Cr{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=((t==null?void 0:t.creationScope)??D).importNode(e,!0);j.currentNode=s;let n=j.nextNode(),o=0,c=0,a=i[0];for(;a!==void 0;){if(o===a.index){let u;a.type===2?u=new kt(n,n.nextSibling,this,t):a.type===1?u=new a.ctor(n,a.name,a.strings,this,t):a.type===6&&(u=new Ur(n,this,t)),this._$AV.push(u),a=i[++c]}o!==(a==null?void 0:a.index)&&(n=j.nextNode(),o++)}return j.currentNode=D,s}p(t){let e=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class kt{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=(s==null?void 0:s.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=st(this,t,e),vt(t)?t===$||t==null||t===""?(this._$AH!==$&&this._$AR(),this._$AH=$):t!==this._$AH&&t!==et&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Sr(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==$&&vt(this._$AH)?this._$AA.nextSibling.data=t:this.T(D.createTextNode(t)),this._$AH=t}$(t){var n;const{values:e,_$litType$:i}=t,s=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=_t.createElement(Vs(i.h,i.h[0]),this.options)),i);if(((n=this._$AH)==null?void 0:n._$AD)===s)this._$AH.p(e);else{const o=new Cr(s,this),c=o.u(this.options);o.p(e),this.T(c),this._$AH=o}}_$AC(t){let e=ns.get(t.strings);return e===void 0&&ns.set(t.strings,e=new _t(t)),e}k(t){ve(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const n of t)s===e.length?e.push(i=new kt(this.O(yt()),this.O(yt()),this,this.options)):i=e[s],i._$AI(n),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,e);t&&t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){var e;this._$AM===void 0&&(this._$Cv=t,(e=this._$AP)==null||e.call(this,t))}}class qt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,n){this.type=1,this._$AH=$,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=$}_$AI(t,e=this,i,s){const n=this.strings;let o=!1;if(n===void 0)t=st(this,t,e,0),o=!vt(t)||t!==this._$AH&&t!==et,o&&(this._$AH=t);else{const c=t;let a,u;for(t=n[0],a=0;a<n.length-1;a++)u=st(this,c[i+a],e,a),u===et&&(u=this._$AH[a]),o||(o=!vt(u)||u!==this._$AH[a]),u===$?t=$:t!==$&&(t+=(u??"")+n[a+1]),this._$AH[a]=u}o&&!s&&this.j(t)}j(t){t===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Tr extends qt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===$?void 0:t}}class Rr extends qt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==$)}}class Or extends qt{constructor(t,e,i,s,n){super(t,e,i,s,n),this.type=5}_$AI(t,e=this){if((t=st(this,t,e,0)??$)===et)return;const i=this._$AH,s=t===$&&i!==$||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==$&&(i===$||s);s&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}}class Ur{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){st(this,t)}}const Xt=pt.litHtmlPolyfillSupport;Xt==null||Xt(_t,kt),(pt.litHtmlVersions??(pt.litHtmlVersions=[])).push("3.2.1");const Ir=(r,t,e)=>{const i=(e==null?void 0:e.renderBefore)??t;let s=i._$litPart$;if(s===void 0){const n=(e==null?void 0:e.renderBefore)??null;i._$litPart$=s=new kt(t.insertBefore(yt(),n),n,void 0,e??{})}return s._$AI(r),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let k=class extends Y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ir(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return et}};var os;k._$litElement$=!0,k.finalized=!0,(os=globalThis.litElementHydrateSupport)==null||os.call(globalThis,{LitElement:k});const te=globalThis.litElementPolyfillSupport;te==null||te({LitElement:k});(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push("4.1.1");const be=class be extends k{constructor(){super(...arguments),this.username=""}connectedCallback(){super.connectedCallback(),this.username=localStorage.getItem("username")||""}toggleDarkMode(t){const e=t.target.checked;document.body.classList.toggle("dark-mode",e)}signOut(){localStorage.removeItem("username"),this.username="",this.requestUpdate()}render(){return y`
  ...
  `;let Ht=be;F({"all-header":Ht,"mu-auth":xt.Provider});window.relayEvent=pi.relay;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Nr={attribute:!0,type:String,converter:Lt,reflect:!1,hasChanged:ye},Mr=(r=Nr,t,e)=>{const{kind:i,metadata:s}=e;let n=globalThis.litPropertyMetadata.get(s);if(n===void 0&&globalThis.litPropertyMetadata.set(s,n=new Map),n.set(e.name,r),i==="accessor"){const{name:o}=e;return{set(c){const a=t.get.call(this);t.set.call(this,c),this.requestUpdate(o,a,r)},init(c){return c!==void 0&&this.P(o,void 0,r),c}}}if(i==="setter"){const{name:o}=e;return function(c){const a=this[o];t.call(this,c),this.requestUpdate(o,a,r)}}throw Error("Unsupported decorator location: "+i)};function _e(r){return(t,e)=>typeof e=="object"?Mr(r,t,e):((i,s,n)=>{const o=s.hasOwnProperty(n);return s.constructor.createProperty(n,o?{...i,wrapped:!0}:i),o?Object.getOwnPropertyDescriptor(s,n):void 0})(r,t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function E(r){return _e({...r,state:!0,attribute:!1})}var Lr=Object.defineProperty,jr=(r,t,e,i)=>{for(var s=void 0,n=r.length-1,o;n>=0;n--)(o=r[n])&&(s=o(t,e,s)||s);return s&&Lr(t,e,s),s};const $e=class $e extends St{constructor(){super("guru:model"),this.searchQuery=""}connectedCallback(){super.connectedCallback(),this.dispatchMessage(["applications/load"])}handleSearch(){const t=this.searchQuery.toLowerCase();this.dispatchMessage(["search/item",{query:t}]),this.searchQuery=""}render(){const{applications:t=[]}=this.model,e={total:t.length,pending:t.filter(s=>s.status==="Pending").length,submitted:t.filter(s=>s.status==="Submitted").length,interview:t.filter(s=>s.status==="Interview Scheduled").length,accepted:t.filter(s=>s.status==="Accepted").length,rejected:t.filter(s=>s.status==="Rejected").length},i=t.slice(0,5);return y`
      <main>
        <!-- Dashboard Section -->
  ...
  `;let bt=$e;jr([E()],bt.prototype,"searchQuery");F({"home-view":bt});var Hr=Object.defineProperty,Qs=(r,t,e,i)=>{for(var s=void 0,n=r.length-1,o;n>=0;n--)(o=r[n])&&(s=o(t,e,s)||s);return s&&Hr(t,e,s),s};const we=class we extends k{constructor(){super(...arguments),this.itemId="",this.recipe=null}connectedCallback(){super.connectedCallback(),console.log("ConnectedCallback -> Item ID:",this.itemId),this.itemId?this.hydrate():console.error("Missing itemId for recipe.")}hydrate(){console.log("Fetching recipe with ID:",this.itemId),fetch(`/api/recipes/${this.itemId}`).then(t=>{if(t.ok)return t.json();throw new Error(`Error fetching recipe: ${t.statusText}`)}).then(t=>{this.recipe={...t,ingredients:t.ingredients||[],instructions:t.instructions||[]}}).catch(t=>{console.error("Failed to fetch recipe:",t)})}render(){if(!this.recipe)return y`<p>Loading recipe...</p>`;const{name:t,servings:e,prepTime:i,ingredients:s,instructions:n,notes:o}=this.recipe;return y`
      <main>
    ...
    `;let it=we;Qs([_e({type:String})],it.prototype,"itemId");Qs([E()],it.prototype,"recipe");var zr=Object.defineProperty,Dr=(r,t,e,i)=>{for(var s=void 0,n=r.length-1,o;n>=0;n--)(o=r[n])&&(s=o(t,e,s)||s);return s&&zr(t,e,s),s};const xe=class xe extends St{constructor(){super("guru:model"),this.searchQuery=""}handleSearch(){const t=this.searchQuery.toLowerCase();this.dispatchMessage(["recipes/search",{query:t}]),this.searchQuery=""}render(){const{recipes:t=[]}=this.model;return y`
      <main>
...
@media (max-width: 600px) {
  ...
  `;let wt=ke;Vr([E()],wt.prototype,"searchQuery");F({"application-search-view":wt});const Qr={companys:[],cartItems:[],totalCost:0,recipes:[],applications:[]};function Ys(r,t,e){switch(r[0]){case"companys/load":Wr(e).then(c=>t(a=>({...a,companys:c}))).catch(c=>{console.error("Failed to fetch companys:",c)});break;case"search/item":const{query:i}=r[1];t(c=>{const a=i.toLowerCase();let u=null;return c.companys.forEach(p=>{p.items.forEach(h=>{h.name.toLowerCase().includes(a)&&(!u||h.price<u.price)&&(u={id:h.id,name:h.name,price:h.price,companyName:p.name})})}),u!==null?{...c,cartItems:[...c.cartItems,u],totalCost:c.totalCost+u.price}:(console.warn(`No items found for query: ${i}`),c)});break;case"recipes/search":console.log("DISPATCHING SEARCH QUERY:",r[1].query),Kr(r[1].query,t,e);break;case"cart/add":t(c=>({...c,cartItems:[...c.cartItems,r[1].item],totalCost:c.totalCost+r[1].item.price}));break;case"cart/removeItem":const{itemId:s}=r[1];t(c=>{const a=c.cartItems.findIndex(u=>u.id===s);if(a!==-1){const u=[...c.cartItems],[p]=u.splice(a,1),h=c.totalCost-p.price*(p.quantity||1);return{...c,cartItems:u,totalCost:h}}return c});break;case"applications/load":Ks(e).then(c=>t(a=>({...a,applications:c}))).catch(c=>{console.error("Failed to fetch applications:",c)});break;case"applications/search":console.log("DISPATCHING SEARCH QUERY:",r[1].query),Yr(r[1].query,t,e);break;case"applications/delete":const{id:n}=r[1];t(c=>{const a=c.applications.filter(u=>u.id!==n);return{...c,applications:a}});break;default:const o=r[0];throw new Error(`Unhandled Auth message "${o}"`)}}function Wr(r){return fetch("/api/companys",{headers:xt.headers(r)}).then(t=>{if(!t.ok)throw t.status===401?new Error("Unauthorized: User must log in."):new Error(`API error: ${t.statusText}`);return t.json()}).then(t=>{if(Array.isArray(t))return t;throw new Error("Unexpected response format")})}function Ks(r){return fetch("/api/applications",{headers:xt.headers(r)}).then(t=>{if(!t.ok)throw t.status===401?new Error("Unauthorized: User must log in."):new Error(`API error: ${t.statusText}`);return t.json()}).then(t=>{if(Array.isArray(t))return t;throw new Error("Unexpected response format")})}function Yr(r,t,e){Ks(e).then(i=>{console.log("FETCHED APPLICATIONS: ",i);const s=r.toLowerCase(),n=i.filter(o=>o.title.toLowerCase().includes(s));t(o=>({...o,applications:n}))}).catch(i=>{console.error("Failed to fetch applications:",i)})}function Kr(r,t,e){Jr(e).then(i=>{console.log("FETCHED RECIPES: ",i);const s=r.toLowerCase(),n=i.filter(o=>o.name.toLowerCase().includes(s));t(o=>({...o,recipes:n}))}).catch(i=>{console.error("Failed to fetch recipes:",i)})}function Jr(r){return fetch("/api/recipes",{headers:xt.headers(r)}).then(t=>{if(!t.ok)throw t.status===401?new Error("Unauthorized: User must log in."):new Error(`API error: ${t.statusText}`);return t.json()}).then(t=>{if(Array.isArray(t))return t;throw new Error("Unexpected response format")})}const Pe=class Pe extends k{render(){return y`
        ...
        `},{path:"/app",view:()=>y`
            <home-view></home-view>
        `},{path:"/",redirect:"/app"}];F({"mu-auth":xt.Provider,"mu-history":_i.Provider,"mu-store":class extends ws.Provider{constructor(){super(Ys,{cartItems:[],companys:[],totalCost:0,recipes:[],applications:[]},"guru:auth")}},"mu-switch":class extends hr.Element{constructor(){super(Gr,"guru:history","guru:auth")}},"grocery-guru-app":oe,"all-header":Ht,"recipe-view":it,"application-view":rt});
